...
public class LiderDistributionSelectionPage extends WizardPage {
	...
	public LiderDistributionSelectionPage(LiderSetupConfig config) {
		super(LiderDistributionSelectionPage.class.getName(), Messages.getString(""), null);
		this.config = config;

		setDescription("2.2 " + Messages.getString(""));
	...
	public void createControl(Composite parent) {
		...
		// From repo
		fromRepoBtn = GUIHelper.createButton(mainContainer, SWT.PUSH, Messages.getString(""));
