...
public class MariaDBConfirmPage extends WizardPage {
	...
	public MariaDBConfirmPage(LiderSetupConfig config) {
		...
		setDescription("2.3 " + Messages.getString("MARIA_DB_INSTALLATION_CONFRIM"));
		this.config = config;
	}
